...
void CFourier::fft_double (unsigned int p_nSamples, bool p_bInverseTransform, double *p_lpRealIn, double *p_lpImagIn, double *p_lpRealOut, double *p_lpImagOut)
{
...
bool CFourier::IsPowerOfTwo( unsigned int p_nX )
{
...
unsigned int CFourier::NumberOfBitsNeeded( unsigned int p_nSamples )
{
...
unsigned int CFourier::ReverseBits(unsigned int p_nIndex, unsigned int p_nBits)
{
...
double CFourier::Index_to_frequency(unsigned int p_nBaseFreq, unsigned int p_nSamples, unsigned int p_nIndex)
{
